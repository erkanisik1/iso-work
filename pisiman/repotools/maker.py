    ...
    if os.path.exists(gdmconf_path):
        ...
        for line in open(gdmconf_path, "r").readlines():
            if line.startswith("[daemon]"):
                ...
                # lines.append("WaylandEnable=true\n")
            else:
                lines.append(line)
...
def squash_live_config_image(project):
    ...
    if project.type == "live":
        ...
        if 'plasma-workspace' in project.all_install_image_packages:
            ...
            os.system("cp -rf %s/%s %s/var/cache/pisi/packages/" % (repo.cache_dir, repo.packages['grub2'].uri, config_image_dir))
...
def squash_image(project):
    ...
    if project.type == "live":
        ...
        if 'lxqt-admin' in project.all_install_image_packages:
            ...
            shutil.copy("./data/lxqt/session.conf",
                    "{}/home/pisi/.config/lxqt/".format(image_dir))
